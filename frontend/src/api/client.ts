import type { Account, AiTurn, Dashboard, TokenPair, Tutor, TutorPreference } from "../models";
...
export const api={
  register:(body:{email:string;password:string;display_name:string})=>raw<Account&{tokens:TokenPair}>("/api/v1/auth/register",{method:"POST",body:JSON.stringify(body)}),
