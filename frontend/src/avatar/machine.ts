...
export const transitions:Record<AvatarState,readonly AvatarState[]>={
 IDLE:["LISTENING","PROCESSING","THINKING","SPEAKING","ERROR"],LISTENING:["PROCESSING","ERROR","PAUSED"],PROCESSING:["THINKING","ERROR","PAUSED"],THINKING:["IDLE","SPEAKING","ERROR","PAUSED"],SPEAKING:["IDLE","ENCOURAGING","CORRECTING","ERROR","PAUSED"],ENCOURAGING:["IDLE","ERROR","PAUSED"],CORRECTING:["IDLE","ERROR","PAUSED"],ERROR:["IDLE"],PAUSED:["IDLE",...active]
};
