...
export function App() {
  ...
  const screen = route === "/app/dashboard" ? <DashboardScreen data={data} tutor={pref.tutor} /> : route === "/app/daily-lesson" ? <DailyLessonScreen /> : route === "/app/conversation" ? <ConversationScreen account={account} tutor={pref.tutor} languageMode={pref.language_mode} /> : route === "/app/progress" ? <ProgressDetailScreen /> : route === "/app/feedback" ? <FeedbackScreen /> : route === "/app/subscription" ? <SubscriptionScreen /> : route === "/app/founder" ? <FounderScreen /> : <SettingsScreen data={data} tutor={pref.tutor} onChange={() => navigate("/onboarding")} />;
