...
def upgrade() -> None:
    ...
    op.create_table("tts_audio_cache_entries", sa.Column("cache_key", sa.String(64), primary_key=True), sa.Column("tutor_voice", sa.String(100), nullable=False), sa.Column("audio_reference", sa.String(200), nullable=False), sa.Column("created_at", sa.DateTime(timezone=True), nullable=False))
